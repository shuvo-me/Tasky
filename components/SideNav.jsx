...
const SideNav = () => {
  ...
  return (
    <div
      className={`fixed top-0 bottom-0  bg-[#FFFFFF] max-w-[345px]  py-[10px] px-[15px] ${
        ...
        <ul>
          {tabs.map((tab) => (
            <li key={Math.random()}>
              <Link href="/">
                <div
                  className={`flex items-center cursor-pointer text-slate-900 py-[8px] px-[22px] pl-[0px] rounded mb-5 `}
                >
